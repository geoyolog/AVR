...
#define I2C_KHZ		100			// ustalamy prÍdkoúÊ na magistrali I2C od 50 kHz do 400 kHz (standard to 100 kHz)
...
#define PCF8574_LCD_ADDR 0x40	// PCF8574  gdy A0, A1 i A2 --> GND  //  --- wyswietlacz 1602 + PCF osobny
//#define PCF8574_LCD_ADDR 0x4E	// PCF8574T gdy A0, A1 i A2 --> nie polaczone // ---- wyswietlacz 2004 z PCF
...
// tu konfigurujemy port i piny do jakich pod≥πczymy linie D7..D4 LCD
	...
	#define LCD_LED 3		// PODåWIETLENIE LCD
...
#define SEND_I2C 		TWI_write_int(PCF8574_LCD_ADDR, mpxLCD)
...
void lcd_LED(uint8_t _on);							// domyúlnie wy≥πczona z kompilacji w pliku lcd.c
